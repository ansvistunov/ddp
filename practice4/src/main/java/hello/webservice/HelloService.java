 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://hello/", wsdlLocation = "http://132.145.228.39:8080/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://hello/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://132.145.228.39:8080/Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://hello/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hello/", "HelloPort"), Hello.class, features);
    }
